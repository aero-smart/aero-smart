<template>
  <button
    :class="[
      ...
      // Variants
      variant === 'primary' && 'bg-primary text-primary-foreground hover:bg-black/90 focus:ring-primary',
      variant === 'secondary' && 'bg-secondary text-secondary-foreground hover:bg-secondary/80 focus:ring-secondary',
      variant === 'outline' && 'border border-gray-200 bg-transparent hover:bg-gray-50 focus:ring-gray-200 text-gray-700',
