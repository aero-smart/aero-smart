<template>
  <aside
    class="w-20 bg-surface flex flex-col items-center py-6 gap-6 border-r border-slate-700 h-full z-50"
  >
    <div class="mb-2">
      <!-- Logo or Brand -->
      <div
        class="w-12 h-12 bg-primary rounded-xl flex items-center justify-center text-white font-bold text-xl shadow-lg shadow-blue-500/20"
      >
        AS
      </div>
    </div>
