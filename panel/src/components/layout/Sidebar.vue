  ...
  >
    ...
    <div class="w-[40px] h-[40px] flex items-center justify-center mt-1">
      <svg width="18" height="28" viewBox="0 0 18 28" fill="none" xmlns="http://www.w3.org/2000/svg">
        <path d="M12.5348 21.7806L8.66407 16.8297L4.74836 21.7806H0L9.75257 13.7466L0.247552 6.02771H5.0184L8.73157 10.7761L12.3097 6.02771H17.0581L12.3097 13.8591L17.3056 21.7806H12.5348Z" fill="black"/>
      </svg>
    </div>

    <!-- Middle: Navigation Group (Frame 38) -->
    <div class="bg-nav-group p-[2px] rounded-lg flex flex-col gap-0 shadow-sm border border-white/50">
      <router-link
