...
use super::constants::BME280_COMMAND_SOFTRESET;
use super::constants::BME280_REGISTER_CHIPID;
use super::constants::BME280_REGISTER_CONFIG;
use super::constants::BME280_REGISTER_CONTROL;
use super::constants::BME280_REGISTER_CONTROLHUMID;
use super::constants::BME280_REGISTER_HUMIDDATA;
use super::constants::BME280_REGISTER_PRESSUREDATA;
use super::constants::BME280_REGISTER_SOFTRESET;
use super::constants::BME280_REGISTER_STATUS;
use super::constants::BME280_REGISTER_TEMPDATA;
use super::constants::DEFAULT_ADDRESS;
use super::constants::MODE_SLEEP;
use super::constants::SKIPPED_HUMIDITY_OUTPUT;
use super::constants::SKIPPED_PRESSURE_OUTPUT;
use super::constants::SKIPPED_TEMPERATURE_OUTPUT;
use super::sample::Humidity;
use super::sample::Pressure;
use super::sample::RawSample;
use super::sample::Sample;
use super::sample::Temperature;
use super::sample::humidity_from_number;
use super::sample::pressure_from_pascal;
use super::sample::temperature_from_celsius;
    ...
    D: DelayNs,
{
    ...
    /// Obtain the chip id
    ///
    /// The chip id is always [`super::constants::CHIP_ID`], so this function
